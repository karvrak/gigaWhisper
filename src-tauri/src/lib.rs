...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::set_custom_transcription_api_key,
            commands::settings::clear_custom_transcription_api_key,
            commands::settings::validate_custom_transcription_api_key_live,
            commands::settings::set_custom_llm_api_key,
            commands::settings::clear_custom_llm_api_key,
            commands::settings::validate_custom_llm_api_key_live,
